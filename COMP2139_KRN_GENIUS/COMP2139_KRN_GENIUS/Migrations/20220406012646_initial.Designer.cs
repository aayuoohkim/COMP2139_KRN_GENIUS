...
namespace COMP2139_KRN_GENIUS.Migrations
{
    ...
    [Migration("20220406012646_initial")]
            ...
            modelBuilder.Entity("COMP2139_KRN_GENIUS.Models.Incident", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            IncidentId = 1,
                            CustomerId = 8,
                            DateClosed = new DateTime(2022, 4, 5, 21, 26, 45, 830, DateTimeKind.Local).AddTicks(3727),
                            DateOpened = new DateTime(2022, 4, 5, 21, 26, 45, 830, DateTimeKind.Local).AddTicks(3701),
                        ...
                        new
                        {
                            IncidentId = 2,
                            CustomerId = 2,
                            DateClosed = new DateTime(2022, 4, 5, 21, 26, 45, 830, DateTimeKind.Local).AddTicks(3731),
                            DateOpened = new DateTime(2022, 4, 5, 21, 26, 45, 830, DateTimeKind.Local).AddTicks(3730),
                        ...
                        new
                        {
                            IncidentId = 3,
                            CustomerId = 3,
                            DateClosed = new DateTime(2022, 4, 5, 21, 26, 45, 830, DateTimeKind.Local).AddTicks(3734),
                            DateOpened = new DateTime(2022, 4, 5, 21, 26, 45, 830, DateTimeKind.Local).AddTicks(3732),
                            Description = "Install fails with error code 410",
                            ProductId = 4,
                            Title = "Could not install"
                        });
            ...
            modelBuilder.Entity("COMP2139_KRN_GENIUS.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            Name = "League Schedular Deluxe 2.0",
                            YearlyPrice = 5.9900000000000002
                        },
                        new
                        {
