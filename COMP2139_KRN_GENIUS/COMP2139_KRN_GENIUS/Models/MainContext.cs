...
namespace COMP2139_KRN_GENIUS.Models
{
    public class MainContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            (
                new Incident { IncidentId = 1, CustomerId = 8, ProductId = 10, Title = "Could not install", Description = "Install fails with error code 410", DateOpened = DateTime.Now, DateClosed = DateTime.Now },
                new Incident { IncidentId = 2, CustomerId = 2, ProductId = 3, Title = "Error launching program", Description = "Program fails with error code 510, unable to open database", DateOpened = DateTime.Now, DateClosed = DateTime.Now },
                new Incident { IncidentId = 3, CustomerId = 3, ProductId = 4, Title = "Could not install", Description = "Install fails with error code 410", DateOpened = DateTime.Now, DateClosed = DateTime.Now}
            );
            ...
            (
                ...
                new Registration { CustomerId = 4, ProductId = 3 }
            );
        }
    }
}
